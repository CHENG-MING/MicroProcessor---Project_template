...
//	 LCD_ShowString(60,90,200,16,16,"Copyright@CHENGMING"); 
//   LCD_ShowString(60,130,200,16,16,"WK_UP:Write KEY0:Read");
//   POINT_COLOR=BLUE;//设置字体为蓝色	 


//LCD_ShowString(30,40,200,24,24,"Mini STM32 ^_^");	
//显示字符串:   x,y:起点坐标;   width,height:区域大小 ;   size:字体大小;   *p:字符串起始地址;

//LCD_ShowxNum(u16 x,u16 y,u32 num,u8 len,u8 size,u8 mode);
//显示数字：    x,y:起点坐标;   num:数值(0~999999999);   len:长度(即要显示的位数);   size:字体大小;   mode:0,非叠加显示;1,叠加显示.

//POINT_COLOR=RED;  设置字体颜色
//LCD_Clear(WHITE); 设置清屏填充
